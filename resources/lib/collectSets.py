...
class CollectSets():
    def __init__(self):
        addonRootDir = xbmc.translatePath('special://profile/addon_data/%s' % ADDON.getAddonInfo('id'))
    ...
    def getCollections(self):
        ...
        collectionsDir = xbmc.translatePath(os_path_join(collectionsDir, 'resources'))
